...
## Build x86_64 image
build@x86_64:
	sudo docker build . -f ./Dockerfile.x86_64 -t wolnosciowiec/wolnosciowiec-notification
...
push@x86_64:
	sudo docker push wolnosciowiec/wolnosciowiec-notification

## Push arm7hf image to registry
push@arm7hf:
	sudo docker push wolnosciowiec/wolnosciowiec-notification:arm7hf
